...
internal sealed class TraceTools
{
    ...
    public static async Task<string> TraceKey(
        ...
        [Description("Items per response section. Defaults to 50.")] int page_size = PageArguments.DefaultPageSize)
    {
    ...
    public static async Task<string> ExportGraph(
        WorkspaceSession session,
        CancellationToken cancellationToken,
