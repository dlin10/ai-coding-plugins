...
public sealed class DescribeTypeTool(RpcClient rpc)
{
	...
	public Task<TypeDescriptionResult> DescribeType(
		...
		[Description("Keep members whose name contains this, ignoring case, or whose humps start with its pieces (TGA finds TryGetAsync)")] string? memberFilter = null,
