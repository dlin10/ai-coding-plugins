...
public sealed class ValidateFileTool(RpcClient rpc)
{
	...
	[Description("Validates a C# file and returns compiler errors, warnings, and optional analyzer diagnostics. success means no compiler errors; requestSucceeded means the request executed.")]
