...
public static class ResponseText
{
    ...
    /// </summary>
    public static string? Fitted(string? text, Func<string?, int> weigh, int budget, string marker)
    {
    ...
    public static string Truncate(string text, int characters, string marker)
    {
    ...
    /// character.</summary>
    public static int WithoutSplitSurrogate(string message, int start, int length) =>
