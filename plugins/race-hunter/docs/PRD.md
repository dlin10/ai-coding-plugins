# Product Requirements Document: Race Hunter
...
Другие возможные будущие направления без обязательств: providers для MassTransit, Quartz, Hangfire, NServiceBus, Wolverine, TPL Dataflow и Akka.NET, deadlock/lock-order analysis, IDE experience/safe code actions и static/runtime correlation. Каждое направление требует отдельного PRD или изменения scope.
