...
Release 0.7.x supports only Windows x64. Use the bundled
`bin/planforge-launcher.ps1`, which invokes `bin/win-x64/planforge.exe`; the Unix
launcher is an unsupported-platform stub. Commands use
