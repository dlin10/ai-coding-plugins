...
Resolver в 5b не вызывается: gaps видны в coverage и uncertainty, а resolver evals по этим кейсам добавляются в 5d. Фаза идёт двумя ранами: первый пишет все кейсы этой таблицы и закрывает вопросы 16, 23, 24 и 28, второй закрывает вопросы 25 и 30.
